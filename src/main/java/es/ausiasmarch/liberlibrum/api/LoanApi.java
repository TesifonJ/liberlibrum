...
public class LoanApi {
    ...
    public ResponseEntity<Page<LoanEntity>> getPage(Pageable oPageable,
        ...
        return ResponseEntity.ok(oLoanService.getPage(oPageable, userId));
    }
    ...
    public ResponseEntity<Page<LoanEntity>> getPageByRepliesNumberDesc(Pageable oPageable,
            @RequestParam(value = "user", defaultValue = "0", required = false) Long userId) {
        return ResponseEntity.ok(oLoanService.getPageByRepliesNumberDesc(oPageable, userId));
    }}
