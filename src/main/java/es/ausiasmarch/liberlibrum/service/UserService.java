...
public class UserService {
    private static final String LIBERLIBRUM_PASSWORD = "e2cac5c5f7e52ab03441bb70e89726ddbd1f6e5b683dde05fb65e0720290179e";
    ...
    public Long create(UserEntity oUserEntity) {
        ...
        oUserEntity.setPassword(LIBERLIBRUM_PASSWORD);
    ...
    public UserEntity update(UserEntity oUserEntityToSet) {
        ...
        if (oSessionService.isUser()) {
            ...
            oUserEntityToSet.setPassword(LIBERLIBRUM_PASSWORD);
